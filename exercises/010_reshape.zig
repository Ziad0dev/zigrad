...
// tinygrad never does: older versions stacked a second view on top of
// the first (exercise 074), and newer ones compose the index maths (073).)
//
